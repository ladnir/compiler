...
namespace Compiler
{
    public class Parser
    {
        ...
        private Node parseConstruct(ILocalScopeNode scope)
        {
            ...
            else if (tok.peep().getValue() == "stdoutnl")
...
Otherwise it is probable out of place");
        ...
        private CallNode parseCall(ILocalScopeNode scope)
        {
            ...
            if (tok.peep().getValue() == "stdout" || tok.peep().getValue() == "stdoutnl")
            {
                throw new NotImplementedException();
            }
            else
            {
                ...
                UserFunctionNode func = scope.getFuncRef(tok.peep().getValue());
